...
class imprimirTabla {
    function imprimirTablaSolucion($tabla, $iteracion, $Zj, $CjmZj){
        ...
        return "<h2 style='margin: 20px'>Tabla de soluciones, iteracion ".$iteracion."</h2><br>"
                . "<table class='table table-hover table-dark'>".$tabla_thead.$tabla_body.$tabla_foot."</table>";
    }
    
    function imprimirFO($funcion_objetivo, $original){
        $html_funcion_objetivo = "<h2>Función Objetivo:</h2><br><table class=' table table-dark table-sm'><tr>";
    ...
    function imprimirRestricciones($restricciones, $original){
        $html_restricciones = "<h2>Restricciones</h2><table class='table table-dark table-sm '>";
    ...
    function imprimirTablaHungaro ($matriz, $tipo){
        $html_hungaro = "<table class='table table-dark table-sm' border='1'><tbody>";
